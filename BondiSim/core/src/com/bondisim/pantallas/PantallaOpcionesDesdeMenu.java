...
public class PantallaOpcionesDesdeMenu implements Screen {
	...
	private Texto opciones[] = new Texto[7];
	...
	private String textos_opciones[] = {"Opciones", "Resolución", "Pantalla Completa", "Teclas",
										"V. General: " + (int) (volumenGeneral*200) + "%", "V. Música: " + (int) (volumenMusica*200) + "%", "Volver"};
	...
	public void show() {
		...
		float anchoTotal = opciones[1].getAncho() + resoluciones[0].getAncho() + 10;	
		opciones[1].setPosicion((anchoPantalla / 2) - (anchoTotal / 2), opciones[1].getY());
